...
func newOrganization(db *gorm.DB, opts ...gen.DOOption) organization {
	...
	_organization.Register = field.NewString(tableName, "register")
	_organization.DetailedLocation = field.NewString(tableName, "detailed_location")
	_organization.Image = field.NewString(tableName, "image")
	_organization.Deleted = field.NewBool(tableName, "deleted")
...
func (o *organization) updateTableName(table string) *organization {
	...
	o.Register = field.NewString(table, "register")
	o.DetailedLocation = field.NewString(table, "detailed_location")
...
func (o *organization) fillFieldMap() {
	...
	o.fieldMap["register"] = o.Register
	o.fieldMap["detailed_location"] = o.DetailedLocation
